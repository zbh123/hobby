...
! function(e) {
	...
	r.prototype.cache = n, r.prototype.define = function(e, t) {
		...
		if (v = v.replace(/^\{\/\}/, ""), !n.modules[d] && layui[d] && (n.modules[d] = v), n.modules[d]) ! function g() {
			...
			h.async = !0, h.charset = "utf-8", y.appendChild(h), !h.attachEvent || h.attachEvent.toString && h.attachEvent.toString().indexOf("[native code") < 0 || i ? h.addEventListener("load", function(e) {
				c(e, v)
		...
		var c = (o || e).replace(/\.|\//g, ""),
			s = u.id = "layuicss-" + c,
			p = 0;
		return u.rel = "stylesheet", u.media = "all", t.getElementById(s) || l.appendChild(u), "function" != typeof r ? i : (function f() {
